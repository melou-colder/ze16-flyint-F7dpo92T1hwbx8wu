...
为了便于分析，在[https://openi.pcl.ac.cn/devilmaycry812839668/google\_brax\_ppo\_pytorch](https://github.com):[蓝猫机场](https://fenfang.org)中将NVIDIA公司的实现所用的trick形成了ppo\_nvidia.py，而Google公司的实现细节形成了ppo\_google.py，从而进行性能比较。
